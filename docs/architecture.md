...
スマホでの見やすさを優先し、ホームにすべての機能を置かず、主要機能をページ単位で分けます。

- `/`: 新しいランタン一覧と灯りを置く操作
- `/search`: 投稿本文の検索
- `/notifications`: 自分のランタンに届いた灯りのお知らせ

全ページ共通で小さなヘッダーを置き、右上のハンバーガーメニューから主要ページへ移動します。ホーム上部の大きな見出しは置かず、投稿一覧が早く見える構成にします。
